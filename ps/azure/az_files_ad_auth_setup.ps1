...
Connect-AzAccount -TenantId 8f716563-cef7-43ab-bf63-f8f26de35ba0

# Define parameters, $StorageAccountName currently has a maximum limit of 15 characters
$tenantId = "tenantguidhere"
$SubscriptionId = "subidguidhere"
...
$OuDistinguishedName = "CN=Computers,DC=company,DC=local"
...
#run this if you get the multiple accounts cached error
Clear-AzContext
