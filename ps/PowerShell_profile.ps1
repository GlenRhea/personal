...
#c:\Users\grhea\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1
#C:\Users\grhea\OneDrive - In-Telecom Consulting\Documents\PowerShell\Microsoft.PowerShell_profile.ps1
...
function fit{Set-Location o:\IT}
